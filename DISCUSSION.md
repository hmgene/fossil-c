...
- Annotated gene features on Bracky_cells contigs (>10 kb) using AUGUSTUS (gff files).
  ```
  /mnt/vstor/SOM_GENE_BEG33/fossil-c/bigdata/augustus/Brachy_Blank.gff
  /mnt/vstor/SOM_GENE_BEG33/fossil-c/bigdata/augustus/Brachy_cells.gff
  ```
...
<details>
        <summary> MapDamage Results </summary>
