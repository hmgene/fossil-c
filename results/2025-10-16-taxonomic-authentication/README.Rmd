...
for (grp in names(groups)) {
  ...
  md_save_pdf(final_plot,paste0("group_", grp, "_grid.png"), width = 10* length(plots)+2, height = 5);
  ...
  combined_row <- plot_grid(plotlist = plots, ncol = length(plots))
  final_plot <- plot_grid(combined_row, legend, ncol = 2, rel_widths = c(1, 0.15))
  md_save_pdf(final_plot,paste0("group_", grp, "_lt60_grid.png"), width = 10* length(plots)+2, height = 5);
}
```
